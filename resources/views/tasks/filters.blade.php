<div class="card">
  <div class="card-body">
    <button class="btn btn-outline-secondary" type="button" data-toggle="collapse" data-target="#collapseForm" aria-expanded="false" aria-controls="collapseExample">
    Filters
  </button>

    <form method="GET" action="{{ route('tasks.index') }}" id="collapseForm" class="collapse{{ $filter ? ' show' : '' }}" >
        ...
        <!-- <input name="orderBy" value="id:asc" type="hidden"> -->
